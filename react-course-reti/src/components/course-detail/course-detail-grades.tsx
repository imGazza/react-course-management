...
import { setGrade } from "@/http/subscriber";
import { ScrollArea } from "../ui/scroll-area";

interface CourseDetailSubscriberProps {
    initialSubscribers: SubscriberEntity[];
}

const CourseDetailGrades = ({ initialSubscribers }: CourseDetailSubscriberProps) => {

    const [gradedSubs, setGradedSubs] = useState<SubscriberEntity[]>([]);
    const [notGradedSubs, setNotGradedSubs] = useState<SubscriberEntity[]>([]);
    const [subscribers, setSubscribers] = useState<SubscriberEntity[]>(initialSubscribers);
    ...
    const handleGradeChange = (value: string, subscriber: SubscriberEntity) => {
