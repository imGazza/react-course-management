...
import { deleteSubscriber, getCourseSubscribers } from "@/http/subscriber"
...
const CourseDetailSubscriber = () => {
    ...
    useEffect(() => {
        const fetchSubscribers = async () => {
            FetchInitialData<Subscriber[], string>(setLoading, setSubscribers, getCourseSubscribers, courseId!);
